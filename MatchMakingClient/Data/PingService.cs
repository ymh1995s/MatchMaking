...
namespace MatchMakingClient.Data
{
    ...
    // Startup.cs에서 DI 컨테이너에 등록되어 Ping.razor에서 주입받아 사용됨
    public class PingService
    {
        ...
        // GET api/ping/ping 요청을 비동기로 보내고 결과를 PingResult로 반환
        ...
        public async Task<PingResult> PingAsync()
        {
            ...
            return await _httpClient.GetFromJsonAsync<PingResult>("api/ping/ping");
        }
    }
}
